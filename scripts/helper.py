...
# import assignment 2 service
from assignment2.srv import MY_SetPose
LOG_TAG = 'HELPER'
...
#
# Move robot through a specified path asking for 'controller' action
#
# UpdateRobotPosition (self, new_position)
#
# Change robot position in the Ontology
#
# Survey (self)
#
...
class Helper:
    ...
    # \param x_value : Float
    #
    # the X_coordinate of the center of the room
    #
    # \param y_value : Float
    #
    # the Y_coordinate of the center of the room
    #
    # \param doors_linked : string[]
    #
    # list of doors linked to the room
    #
    # \param connections : string[]
    #
    # list of adjacent reachable rooms
    #
    # \param last_call : boolean
    #
    # flag to state last function call
    #
    # \return [None]
    #
    ##
    ...
    ##
    # function to Move robot through a specified path asking for 'controller' action
    # ...
    # ----------
    # \param plan : PlanGoal():
    #
    ...
    def MoveRobot(self, plan, check_battery):
         ...
         while not rospy.is_shutdown():
             ...
             if(self.is_battery_low() and check_battery == 1): # check_battery == 0 means robot has to go back to rech station
                 ...
                 # send a cancel_all_goals to 'controller' server of controller.py ! NOTA qui cancello il 'controller' non direttamente il 'move_base'
                 self.controller_client.cancel_goals()
